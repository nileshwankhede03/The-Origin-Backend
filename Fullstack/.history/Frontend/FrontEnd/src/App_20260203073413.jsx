...
const App = () => {
  ...
  const [formCD, setformCD] = useState(second)
  ...
  return (
    <>
      <form className='note-create-form' onSubmit={handleSubmit} >
        <input name='title' type="text" placeholder='Enter title' value={} onChange={handleChange} />
        <input name='description' type="text" placeholder='Enter description' value={} onChange={handleChange} />
